...
public:
	...
	void DrawHexa(Point P1, GfxInfo RectGfxInfo, bool selected=false) const;  //Draw a Hexagon
	void DrawCir(Point P1, Point P2, GfxInfo RectGfxInfo, bool selected=false) const;  //Draw a rectangle
